...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <style>
    ...
    <div id="chatroom_login" class="form-group leaf" style="background-image: url('/Images/if-i-had-a-flower-by-nicola-pearson-if-i-had-a-flower.jpg'); background-repeat: no-repeat;" >
